      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-soft md:p-5">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">Tap a numbered location or gate on the map, or search below.</p>
          </div>
        ...
        <div className="overflow-auto bg-slate-100 p-2 md:p-4">
          <div className="relative mx-auto min-w-[720px] w-full max-w-[1400px]" style={{ aspectRatio: "3405.26 / 1100" }}>
            <div className="absolute inset-0 overflow-hidden rounded-2xl">
              <img src="/Campus Map.svg" alt="Official NCPLE Addu Campus map showing numbered campus locations and gates" className="block h-auto w-full select-none" draggable={false} />
            </div>
